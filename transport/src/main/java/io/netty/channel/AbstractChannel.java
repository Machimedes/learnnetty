...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
    ...
    protected AbstractChannel(Channel parent, ChannelId id) {
        ...
        unsafe = newUnsafe();
        pipeline = newChannelPipeline();
        NoteLogger.logNote("构造channel时每个channel会创建各自的unsafe和pipeline", unsafe, pipeline);
    }
    ...
    protected abstract class AbstractUnsafe implements Unsafe {
        ...
        public final void register(EventLoop eventLoop, final ChannelPromise promise) {
            ...
            NoteLogger.logNote("此时channel在绑定对应的eventLoop");
            ...
            if (eventLoop.inEventLoop()) {
                ...
                try {
                    NoteLogger.logNote("serverSocketChannel注册必然是异步执行");
        ...
        private void register0(ChannelPromise promise) {
            try {
                ...
                NoteLogger.logNote("查看unsafe的外部类", this, AbstractChannel.this, AbstractChannel.this.unsafe);
                doRegister();
